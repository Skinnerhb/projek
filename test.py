        ...
        html.Div(
            ...
            children=[
                dcc.Tabs(
                    ...
                    value='tab-1',
                    children=[
                        dcc.Tab(label='Broadband', value='tab-1'),
                        dcc.Tab(label='Illuminance',value='tab-2'),
                        dcc.Tab(label='Flicker', value='tab-3')
                        ]
                     ),
        ...
        return html.Div(
            children =[
                ...
                dcc.Graph(
                    ...
                    figure ={
                        'data': [
                            {'x': [1, 2, 3, 4, 5], 'y': [4, 1, 2, 3, 4], 'type': 'line', 'name': 'illuminance'}
                            ],
                        'layout': {
        ...
        return html.Div(
            children =[
                ...
                dcc.Graph(
                    ...
                    figure ={
                        'data': [
                            {'x': [1, 2, 3, 4, 5], 'y': [4, 1, 2, 3, 4], 'type': 'line', 'name': 'flicker'}
                            ],
                        'layout': {
                            'plot_bgcolor': colorst['pbackground'],
                            'paper_bgcolor': colorst['ebackground'],
